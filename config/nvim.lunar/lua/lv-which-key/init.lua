...
vim.api.nvim_set_keymap('n', '<space>/', ':Telescope live_grep<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<space>k', ':Telescope grep_string<CR>', {noremap = true, silent = true})
